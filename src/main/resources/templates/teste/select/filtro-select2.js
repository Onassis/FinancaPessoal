$(document).ready(function() {
    ...
    $('.seletOpt').each(function() {
        ...
        // Usa o placeholder do select original se existir, senão usa um padrão
        ...
        $selectOriginal.find('option').each(function() {
            ...
            // Ignora a primeira opção se ela for um placeholder sem valor
        ...
        $inputFiltro.on('focus', function(e) {
            e.stopPropagation();
            // Mostra apenas a lista de opções deste componente específico
            $('.filtro-select-opcoes').hide(); // Esconde todas as outras
            $listaOpcoes.show();
        });
