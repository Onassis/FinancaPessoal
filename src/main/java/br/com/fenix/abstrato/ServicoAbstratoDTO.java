...
public abstract class ServicoAbstratoDTO<T,TDO,ID> implements IServicoDTO<T,TDO,ID>{

	 CrudRepository<T, ID> repositorio;

	 public ServicoAbstratoDTO(CrudRepository<T,ID> repositorio) {
...
//	    }
	    ...
	    @Override
	    @Transactional
	    public T criar( TDO dto ) throws NegocioException {
	    	T entidade = dtoToEntidade(dto); 
	    	antesDeSalvar(entidade);
		    return  repositorio.save (entidade);
	    }


	    protected abstract T dtoToEntidade(TDO dto);
