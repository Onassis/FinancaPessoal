...
public abstract class ControleAbstratoOld2<S extends ServicoAbstrato,T extends Persistable<ID>,ID> 
			implements IControleOld<T ,ID>{
	...
	public ControleAbstratoOld2(S servico) {
		super();
