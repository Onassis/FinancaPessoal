...
@AllArgsConstructor
@SuperBuilder
public abstract class EntidadeAbstrataTest<ID> implements Persistable<ID>,  Serializable  {
	/**
	 * 
	 */
   ...
   @Transient
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EntidadeAbstrataTest other = (EntidadeAbstrataTest) obj;
