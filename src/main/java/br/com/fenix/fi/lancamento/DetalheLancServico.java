...
@Service
public class DetalheLancServico  extends ServicoAbstratoDTO<DetalheLancamento,DetalheLancDTO,Long> implements IServicoDTO<DetalheLancamento,DetalheLancDTO,Long> { 
...
//	LancamentoRepositorio lancamentoRP;
   ...
   @Autowired
   private DetalheLancMapper modelMapper;
   ...
   public DetalheLancServico(EntityManagerFactory emf) {
	...
	@Override
	public DetalheLancMapper getConverter() {
		// TODO Auto-generated method stub
		return modelMapper;
	}
...
//	}
//	
	public List<DetalheLancDTO> listaPorMesAno (String mesLancamento ) {
		...
		try {
		 ...
		 List<DetalheLancDTO> dtos =  DtlancamentoRP
...
//		
//		List<DetalheLancDTO> detalheLancDTOs =  new ArrayList<DetalheLancDTO>(); 
//		
//		DetalheLancDTO lancamentoDTO = new DetalheLancDTO();  
//		for(DetalheLancamento detLanc : detalheLancamentos) {      
//			try { 
//				DetalheLancDTO detalheLancDTO = modelMapper.convertToDto(detLanc);
//			} catch (Exception e) {
//				System.out.print("Erro de converção Detalhe -> LancamentoDTO : ");
//				System.out.println(detLanc.getId());
//			}
//			detalheLancDTOs.add(lancamentoDTO);
//		}			
//		  System.out.println("Lista todos ");
//		  return detalheLancDTOs;
	}
//	
//	@Transactional
